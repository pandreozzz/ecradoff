...
contains
  ...
  SUBROUTINE get_flexi_lutvals(lut_maps, nmaps, map_size, nwspeed, nspec, nvals, max_lut_bins, &
    ...
    real(realk) :: a, w, w1, w2, z, z1, z2

    integer(intk) :: num_threads, thread_id
    integer(intk) :: n_chunks
    real(db) :: timer
    ...
    !$OMP PARALLEL PRIVATE(idx_val, num_threads, thread_id, tgtbins, tgtbounds, &
    !$OMP& i, lut_index_tuples, a, w, w1, w2, z, z1, z2, &
