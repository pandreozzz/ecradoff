"""Hosting code for size distribution calculations"""
...
def get_nccn_over_mcon_from_specs(
    ...
    """Convenience wrapper using an `AeroPSD` instance."""
...
def get_nccn_over_mcon_from_speclist(specs: Dict[str, AeroPSD]) -> Dict[str, float]:
